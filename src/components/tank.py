...
class FixedRoofTankShim:
    """
    Shim to hold all calculation functions and intermediate calculations associated with a fixed roof tank.
    This is done to allow the DB definition class to not have all the complexity of the calculation equations.
    """
    tank: FixedRoofTank

    def __getattr__(self, name):
        # Allow us to pretend like we are the actually the tank
