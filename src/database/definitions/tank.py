...
class FixedRoofTank(MappedAsDataclass, OrmBase):
    ...
    shell_height: Mapped[str] = mapped_column(default='')
    shell_diameter: Mapped[str] = mapped_column(default='')
    ...
    roof_height: Mapped[str] = mapped_column(default='')
    roof_slope: Mapped[str] = mapped_column(default='')
    roof_radius: Mapped[str] = mapped_column(default='')

    vent_vacuum_setting: Mapped[str] = mapped_column(default='-0.3')
    vent_breather_setting: Mapped[str] = mapped_column(default='0.3')

    maximum_liquid_height: Mapped[str] = mapped_column(default='')
    average_liquid_height: Mapped[str] = mapped_column(default='')
    working_volume: Mapped[str] = mapped_column(default='')
    turnovers_per_year: Mapped[str] = mapped_column(default='')
    net_throughput: Mapped[str] = mapped_column(default='')
