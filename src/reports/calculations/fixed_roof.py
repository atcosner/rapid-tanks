...
class FixedRoofEmissions:
    ...
    def _calculate_standing_losses(self) -> Quantity:
        logger.info(f'Calculating standing losses for "{self.tank.name}" at "{self.facility_name}"')
    ...
    #     logger.info(f'Calculating working losses for "{self.tank.name}" at "{self.facility_name}"')
    #
    #     # AP 42 Chapter 7 Equation 1-35
    ...
    def calculate_total_emissions(self) -> TankEmission:
        ...
        # return {part.material.name: part.weight_fraction * total_losses for part in self.tank.mixture.parts}
